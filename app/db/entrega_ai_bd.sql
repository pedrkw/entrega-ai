...
(1, 'Pedido Recebido', 'Eba! Recebemos seu pedido! Estamos conectando você a um motorista parceiro que logo estará a caminho.', 'fa-exclamation-triangle', 'bg-warning', '2023-11-17 01:56:23', '2023-11-25 00:47:11'),
(2, 'Motorista Confirmado', 'Excelente! Um motorista parceiro já aceitou seu pedido. Ele está se preparando para buscar ou entregar seu item!', 'fa-check-square-o', 'bg-info', '2023-11-17 01:56:23', '2023-11-25 00:49:25'),
(3, 'A Caminho', 'Seu motorista está a caminho para buscar ou entregar seu item. Logo logo ele chega, tudo pronto para você!', 'fa-truck', 'bg-info', '2023-11-17 01:56:23', '2023-11-25 00:49:46'),
(4, 'Entrega Concluída', 'Sucesso! Seu pedido foi entregue com carinho pelo nosso motorista parceiro. Obrigado por contar com a gente!', 'fa-check-square-o', 'bg-success', '2023-11-17 01:56:23', '2023-11-25 00:49:39'),
(5, 'Pegou sua encomenda', 'O motorista acabou de pegar sua encomenda e já está a caminho', 'fa-archive', 'bg-success', '2023-11-16 20:00:00', '2023-11-25 01:19:09'),
(6, 'Cancelado pelo Motorista', 'O motorista parceiro cancelou o pedido de entrega.', 'fa-ban', 'bg-danger', '2023-11-16 20:00:00', '2023-11-25 00:48:30'),
(7, 'Problemas de Entrega', 'Houve um problema durante a entrega. Estamos resolvendo para garantir a melhor experiência.', 'fa-exclamation-triangle', 'bg-warning', '2023-11-16 20:00:00', '2023-11-25 00:52:25'),
(8, 'Entrega Adiada', 'Sua entrega foi adiada para um novo horário. Desculpe pelo inconveniente!', 'fa-clock-o', 'bg-warning', '2023-11-16 20:00:00', '2023-11-25 00:52:22'),
(11, 'Entrega Devolvida', 'Sua entrega foi devolvida ao remetente.', 'path/to/icon/returned.png', 'returned', '2023-11-16 20:00:00', '2023-11-16 20:00:00'),
(12, 'Cancelado pelo usuário', 'Você cancelou essa entrega', 'fa-ban', 'bg-danger', '2023-11-25 00:31:35', '2023-11-25 00:48:26');
